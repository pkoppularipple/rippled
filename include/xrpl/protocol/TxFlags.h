...
#define XMACRO(TRANSACTION, TF_FLAG, TF_FLAG2, MASK_ADJ)                                                                                                       \
    ...
    TRANSACTION(MPTokenIssuanceCreate,                                                                                                                         \
        ...
        TF_FLAG(tfMPTCanConfidentialAmount, lsfMPTCanConfidentialAmount),    /* XLS-0096 Confidential MPT */                                                   \
        MASK_ADJ(0))                                                                                                                                           \
                                                                                                                                                               \
...
// XLS-0096: if set at creation, the lsfMPTCanConfidentialAmount flag can never
// be toggled after issuance.
...
// XLS-0096: set or clear the lsfMPTCanConfidentialAmount flag post-issuance.
