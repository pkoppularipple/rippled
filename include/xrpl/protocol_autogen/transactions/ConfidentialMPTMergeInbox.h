...
{
public:
    static constexpr xrpl::TxType txType = ttMPTOKEN_MERGE_INBOX;
...
public:
    ...
    ConfidentialMPTMergeInboxBuilder(SF_ACCOUNT::type::value_type account,
        ...
        : TransactionBuilderBase<ConfidentialMPTMergeInboxBuilder>(ttMPTOKEN_MERGE_INBOX, account, sequence, fee)
    {
    ...
    {
        if (tx->getTxnType() != ttMPTOKEN_MERGE_INBOX)
        {
